...
<tr>
	...
	<td></td>
					...
					<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control" id="condiciones" style="width:190px" >
							...
							<div class="col-md-2">
								<select class="form-control" id="validez">
									<option value='5 días'>5 días (descuento 10%)</option>
									<option value='10 días'>10 días</option>
									<option value='15 días' selected>15 días</option>
								</select>
							</div>
							<label for="entrega" class="col-md-1 control-label">Entrega:</label>
							<div class="col-md-2">
							<select class="form-control" id="entrega" style="width:200px" >
									<option value='1 días'>1 días (adicional 15$)</option>
									<option value='3 días'>3 días (adicioanl 5$)</option>
									<option value='5 días' selected>5 días</option>
									<option value='10 días'>10 días (descuento 5$)</option>
									<option value='15 días'>15 días (descuento 5%)</option>
								</select>
							</div>
						</div>