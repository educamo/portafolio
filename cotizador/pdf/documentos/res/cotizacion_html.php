...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
		<td style="width:50%; "><strong>Dirección:</strong> <br>Urb. Los Mangos, calle 119 Valencia 2001 - Venezuela<br> Teléfono.: (+58)412-0566617</td>
	...
	*** Ciertas Condiciones aplican ***
    ...
    <br><br>	
	  ...
	  <table cellspacing="10" style="width: 100%; text-align: left; font-size: 11pt;">
			 ...
			 <tr>
               <td style="width:100%;">Todos los precios son dentro de la Ciudad de Valencia</td>
            </tr>
            <tr>
               <td style="width:100%;">En caso de no ser así el cliente se compromete al pago de traslado ida y vuelta</td>
            </tr>
            <tr>
               <td style="width:100%;">El cliente se compromete a garantizar la seguridad tanto de los equipos como del personal</td>
            </tr>
            <tr>
               <td style="width:100%;">Cualquier gasto de viático es por cuenta del cliente</td>
            </tr>
